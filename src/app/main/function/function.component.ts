...
export class FunctionComponent implements OnInit {
  ...
  public savePermission(valid: boolean | null, _permission: any[]) {
    if (valid) {
      var data = {
        Permissions: this._permission,
        FunctionId: this.functionId
      }
      this._dataService.post('/api/appRole/savePermission', JSON.parse(JSON.stringify(data))).subscribe((response: any) => {
  ...
  public search() {
    ...
    public saveChanges(valid: boolean | null) {
      if (valid) {
        if (this.editFlag == false) {
          this._dataService.post('/api/function/add', JSON.parse(JSON.stringify(this.entity))).subscribe((response: any) => {
            this.search();
          ...
          this._dataService.put('/api/function/update', JSON.parse(JSON.stringify(this.entity))).subscribe((response: any) => {
            this.search();
            this.addEditModal.hide();
